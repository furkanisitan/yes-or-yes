...
export default function SurveyContainer() {
  ...
  return (
    <div
      className={`w-full min-h-[100dvh] flex flex-col items-center px-4 pt-4 md:pt-8 lg:pt-12 ${survey.className}`}
    >
      ...
      <h1 className={`mb-2 md:mb-4 lg:mb-6 text-xl md:text-3xl lg:text-5xl drop-shadow-lg ${survey.titleClassName}`}>{survey.title}</h1>
